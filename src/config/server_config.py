...
AdminConfigVar_1=AdminTask.createDatasource(AdminConfigVar_0, ["-name", "Default Datasource", "-jndiName", "DefaultDatasource", "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DerbyDataStoreHelper", "-configureResourceProperties", "[[databaseName java.lang.String ${APP_INSTALL_ROOT}/${CELL}/javax-servlets-1.0-SNAPSHOT.ear/DefaultDB] ]"])
...
#AdminApp.install('/path/to/javax-servlets-1.0-SNAPSHOT.ear', ["-node", NodeName, "-server", "server1", "-appname", "javax-servlets-1.0-SNAPSHOT.ear", "-CtxRootForWebMod", [["Default Web Application", "javax-servlets-1.0-SNAPSHOT.war,WEB-INF/web.xml", "/"]]])
AdminConfig.save()
